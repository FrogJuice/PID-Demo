...
public class Drivebase extends Subsystem implements PIDOutput {
    ...
    private final double kP = SmartDashboard.getNumber("P", 0.0);
    private final double kI = SmartDashboard.getNumber("I", 0.0);
    private final double kD = SmartDashboard.getNumber("D", 0.0);
    ...
    protected void initDefaultCommand() {
        setDefaultCommand(new TurnToAngle(45.0));
    }
